...
export const placeOrder = (subtotal) => async (dispatch, getState) => {
			...
			handler: async (response) => {
				try {
					const { data } = await axios.post(
						'https://pizza-backend-gules.vercel.app/api/payment/verifypayment',
	...
	try {
		const { data } = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/payment/orders',
			{ subtotal },
		);
...
export const getUserOrders = () => async (dispatch, getState) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/payment/getuserorders',
			{ userId: user._id },
		);
...
export const getAllOrders = () => async (dispatch) => {
	...
	try {
		const response = await axios.get(
			'https://pizza-backend-gules.vercel.app/api/payment/getallorders',
		);
		console.log(response);
...
export const deliverOrder = (orderid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/payment/deliverorder',
			{ orderid: orderid },
		);
		console.log(response);

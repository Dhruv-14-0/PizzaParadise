...
export const getAllBases = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizza-backend-gules.vercel.app/api/myopizza/getallbases',
	);
...
export const getAllSauces = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizza-backend-gules.vercel.app/api/myopizza/getallsauces',
	);
	// console.log(response);
...
export const getAllToppings = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizza-backend-gules.vercel.app/api/myopizza/getalltoppings',
	);
	// console.log(response);
...
export const getAllCheese = () => async (dispatch) => {
	...
	const response = await axios.get(
		'https://pizza-backend-gules.vercel.app/api/myopizza/getallcheese',
	);
	// console.log(response);
...
export const addBase = (base) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/addbase',
			{ base: base },
		);
		console.log(response);
...
export const getBaseById = (baseid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/getbasebyid',
			{ baseid: baseid },
		);
		console.log(response);
...
export const updateBase = (updatedBase) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/updatebase',
...
export const deleteBase = (baseid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/deletebase',
			{ baseid: baseid },
		);
		console.log(response);
...
export const addTopping = (topping) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/addtopping',
			{ topping: topping },
		);
		console.log(response);
...
export const getToppingById = (toppingid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/gettoppingbyid',
			{ toppingid: toppingid },
		);
		console.log(response);
...
export const updateTopping = (updatedTopping) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/updatetopping',
...
export const deleteTopping = (toppingid) => async (dispatch) => {
	...
	try {
		const response = await axios.post(
			'https://pizza-backend-gules.vercel.app/api/myopizza/deletetopping',
			{ toppingid: toppingid },
		);
		console.log(response);
